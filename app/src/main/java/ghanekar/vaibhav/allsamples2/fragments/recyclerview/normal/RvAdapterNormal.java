...
public class RvAdapterNormal extends RecyclerView.Adapter<RvAdapterNormal.MyViewHolder> {

    private Context context;
    private ArrayList<ModelRecyclerView> arrayList;

    public RvAdapterNormal(Activity context, ArrayList<ModelRecyclerView> arrayList) {
