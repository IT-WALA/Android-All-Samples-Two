...
public class RvAdapterPulltoRefresh extends RecyclerView.Adapter<RvAdapterPulltoRefresh.MyViewHolder> {

    private Context context;
    private ArrayList<ModelRecyclerView> arrayList;

    public RvAdapterPulltoRefresh(Activity context, ArrayList<ModelRecyclerView> arrayList) {
