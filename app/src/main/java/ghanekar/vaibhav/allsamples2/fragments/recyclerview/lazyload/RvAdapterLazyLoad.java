...
public class RvAdapterLazyLoad extends RecyclerView.Adapter<RvAdapterLazyLoad.MyViewHolder> {

    private Context context;
    private ArrayList<ModelRecyclerView> arrayList;

    public RvAdapterLazyLoad(Activity context, ArrayList<ModelRecyclerView> arrayList) {
